...
class Linear(DQN):
    ...
    def get_q_values_op(self, state, scope, reuse=False):
        ...
        out = layers.fully_connected(inputs=flat, num_outputs=num_actions, scope=scope, activation_fn=None, weights_initializer=layers.xavier_initializer(), reuse=reuse)
